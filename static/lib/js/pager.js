...
define(["require", "exports"], function (require, exports) {
    ...
    var Pager = (function () {
        ...
        Pager.prototype.pagination = function (container, pageIndex, total, pageSize, func, href, config) {
            var totalPage = total;
        ...
        Pager.prototype.doAjaxPager = function (container, curPage, totalPage, func, href, config) {
            var divPager = typeof (container) == "string" ? document.getElementById(container) : container;
            if (!divPager || !divPager.tagName)
                return;
            divPager.innerHTML = "";
            if (totalPage < 2)
                return;
